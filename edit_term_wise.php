...
echo "<script>
    location='edit_term_wise.php';
    window.open('subject_wise_edit.php?cls=$class_id&sec=$section_id&exm=$term_id&subject=$subject','_newtab');
    </script>";   
...
<div class="page-content-wrapper">
		<div class="page-content">
			...
			<div class="portlet-title">
				<div class="caption">
					<i class="icon-puzzle"></i> Edit Term Wise
				</div>
			</div>
...
$(document).ready(function() {		
	...
	$(".user1").live("change",function(){
		...
		if(k.length >0 ){
		$.ajax({
			url: "edit_term_wise_ajax.php?pon="+t+"&pon1="+k,
	...
	$(".user").live("change",function(){
		...
		if(k.length >0 ){
		$.ajax({
			url: "edit_term_wise_ajax.php?pon="+t,
			}).done(function(response) {
			$("#call1").html(""+response+"");
		});
		}
